...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Record.client'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['clients.Client']))
        db.alter_column('export_record', 'client_id', orm['export.record:client'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Record.client'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['clients.Client'], null=True, blank=True))
        db.alter_column('export_record', 'client_id', orm['export.record:client'])
