...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Record.proforma_invoice_file'
        db.delete_column('export_record', 'proforma_invoice_file')
        
    
    
    def backwards(self, orm):
        
        # Adding field 'Record.proforma_invoice_file'
        db.add_column('export_record', 'proforma_invoice_file', orm['export.record:proforma_invoice_file'])
