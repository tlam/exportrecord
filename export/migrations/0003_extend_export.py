...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProformaInvoiceFile'
        db.create_table('export_proformainvoicefile', (
            ('id', orm['export.ProformaInvoiceFile:id']),
            ('file', orm['export.ProformaInvoiceFile:file']),
            ('record', orm['export.ProformaInvoiceFile:record']),
        ))
        db.send_create_signal('export', ['ProformaInvoiceFile'])
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'ProformaInvoiceFile'
        db.delete_table('export_proformainvoicefile')
